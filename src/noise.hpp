...
class NoiseEstimator {
	...
	private:
		...
		const arma::uvec DegOFreePlus1 = {2, 4, 8, 16, 32, 64, 128, 256, 512, 1024};
		const arma::vec Ftest0100 = {5.39077,1.97222,1.38391,1.17439,1.08347,1.04087,1.02023,1.01006,1.00502,1.00251};
		const arma::vec Ftest0050 = {9.27663,2.40345,1.51833,1.22924,1.10838,1.05276,1.02604,1.01293,1.00645,1.00322};
		const arma::vec Ftest0025 = {15.4392,2.86209,1.64602,1.27893,1.13046,1.06318,1.03110,1.01543,1.00769,1.00384};
		const arma::vec Ftest0010 = {29.4567,3.52219,1.80896,1.33932,1.15670,1.07543,1.03702,1.01834,1.00913,1.00455};
