 ...
 */
    ...
    public:
        ...
        engine(SeedSeq &&seedSeq, typename std::enable_if<
                                      !stream_mixin::can_specify_stream && !std::is_convertible<SeedSeq, itype>::value && !std::is_convertible<SeedSeq, engine>::value,
 ...
 */
    ...
    public:
        template <typename SeedSeq, typename = typename std::enable_if<
                                        !std::is_convertible<SeedSeq, result_type>::value && !std::is_convertible<SeedSeq, extended>::value>::type>
                                   ...
                                   baseclass, extvalclass, kdd> &rhs)
    {
        ...
        return base_lhs == base_rhs && std::equal(
