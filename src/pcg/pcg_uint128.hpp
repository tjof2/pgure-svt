...
#define PCG_LITTLE_ENDIAN 1
#elif __powerpc__ || __POWERPC__ || __ppc__ || __PPC__ || __m68k__ || __mc68000__
#define PCG_LITTLE_ENDIAN 0
#else
...
#pragma intrinsic(_BitScanReverse64, _BitScanForward64)
    ...
    public:
        ...
        template <class Integral,
                  typename std::enable_if<(std::is_integral<Integral>::value && sizeof(Integral) <= sizeof(UIntX2))>::type * = nullptr>
